...
docker run -it -d -p 5000:80 --name ImpliciteTest ghcr.io/fevanmanshoven/docker-implicite-test:main >nul 2>&1
echo "Running application..."
docker start ImpliciteTest >nul 2>&1
echo "Loading..."
timeout 5 >nul 2>&1
